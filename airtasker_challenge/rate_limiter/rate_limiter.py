...
class RateLimiter:
    ...
    approximated).
    Changing the implementation of `RateLimiter::_store_key` and
    `RateLimiter::_previous_store_keys` to take bucket duration into account
    would be sufficient.
    ...
    def _current_permits(self, requestor: str, now_s: int) -> int:
        ...
        :param requestor: an identifier for a requestor.
        :param time_s: the current time, in seconds since epoch
